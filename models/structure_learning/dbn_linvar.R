...
A <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_struct_r_0.csv", 
              header = FALSE, sep = " ")
A <- as.matrix(A)
A
...
df <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_data_r_0.csv", 
               header = FALSE, sep = " ")
...
df <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_data_r_1.csv", 
               header = FALSE, sep = " ")
A_hat <- inferGC_dbn_K1(df, method = method)
A_hat
...
df <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_data_r_2.csv", 
               header = FALSE, sep = " ")
A_hat <- inferGC_dbn_K1(df, method = method)
A_hat
...
df <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_data_r_3.csv", 
               header = FALSE, sep = " ")
A_hat <- inferGC_dbn_K1(df, method = method)
A_hat
...
df <- read.csv("/mnt/data_disk/Projects/SENGC/datasets/experiment_data/linear-var/linear-var_data_r_4.csv", 
               header = FALSE, sep = " ")
A_hat <- inferGC_dbn_K1(df, method = method)
A_hat
